...
class EnhancedTrajectoryEngine:
    ...
    def update(self, dt: float) -> Dict[str, Any]:
        ...
        for sid in active_sources:
            ...
            # Actualizar motion con parámetros correctos
            updated_state = motion.update(motion.state, t, dt)
            pos = updated_state.position
            orient = updated_state.orientation
            aperture = updated_state.aperture
