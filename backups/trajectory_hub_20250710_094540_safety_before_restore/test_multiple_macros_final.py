#!/usr/bin/env python3
"""
🧪 Test: Crear múltiples macros (versión final)
"""
...
def test_macros():
    ...
    # Inicializar engine primero
    engine = EnhancedTrajectoryEngine()
    
    # El OSC bridge ya está inicializado dentro del engine
    print("✅ Engine inicializado")
    
    # Iniciar el loop
    engine.start()
    print("✅ Engine loop iniciado")
    ...
    # Esperar un poco
    print("\n⏱️ Esperando 10 segundos para verificar en Spat...")
    time.sleep(10)
