...
class InteractiveController:
    ...
    async def main_menu(self):
        ...
        while self.running:
            ...
            print("7. MS → Desfase entre Macros (próximamente)")
            ...
            try:
                ...
                # MACRO SOURCE (MS)
                    ...
                    print("\n⚠️  Función en desarrollo: Desfase entre Macros")
                ...
                # ESPACIALIZACIÓN
                    ...
                    print("\n⚠️  Función en desarrollo: Concentración en Punto")
                elif choice == "32":
    ...
    async def set_macro_trajectory(self):
        ...
        try:
            ...
            if choice == 1:  # Círculo
                ...
                print("\n📝 Función personalizada no implementada aún")
                return
