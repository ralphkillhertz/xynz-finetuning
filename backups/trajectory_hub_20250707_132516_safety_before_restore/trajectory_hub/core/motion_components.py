...
import numpy as np
from trajectory_hub.core.delta_system import MotionDelta, MotionComponent, DeltaComposer
...
class SourceMotion:
    ...
    def __init__(self, source_id: int):
        ...
        # Sistema de componentes para arquitectura de deltas
        self.motion_components = {}  # Dict[str, MotionComponent]
        self.component_weights = {}  # Pesos para cada componente
        self.use_delta_system = False  # Flag para migración gradual
